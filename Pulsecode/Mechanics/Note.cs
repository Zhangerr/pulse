...
namespace Pulse.Mechanics
{
    public class Note
    {
        ...
        public Note(int offset, int location, string texturePath, bool hold, int holdOffset, string holdPath)
        {
            ...
            holdHighlightTexture.Colour = new OpenTK.Graphics.Color4(1.0f, 1.0f, 1.0f, 1.0f);
            ...
            highlightTexture.Colour = new OpenTK.Graphics.Color4(1.0f, 1.0f, 1.0f, 1.0f);
        ...
        public void setAlpha(float a)
        {
            if (hold)
            {
                holdbar.Colour = new OpenTK.Graphics.Color4(holdbar.Colour.R, holdbar.Colour.G, holdbar.Colour.B, a);
                holdEnd.Colour = new OpenTK.Graphics.Color4(holdEnd.Colour.R, holdEnd.Colour.G, holdEnd.Colour.B, a);
                holdStart.Colour = new OpenTK.Graphics.Color4(holdStart.Colour.R, holdStart.Colour.G, holdStart.Colour.B, a);
            }
        ...
        public void setColor()
        {
            ...
            {
                holdEnd.Colour = Skin.EndColors[location - 1];
                holdEnd.Alpha = 1.0f;
                holdbar.Colour = Skin.KeyColours[location - 1];
                holdbar.Alpha = 1.0f;
                holdStart.Colour = Skin.StartColors[location - 1];
