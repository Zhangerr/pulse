...
namespace Pulse
{
    public class Text
    {
        ...
        public Font TextFont
        {
            ...
            {
                textFont = value;
               // Update(Line); //updatesize updates the line
                updatesize(Line);
            }
        }
        ...
        */
        ...
        public virtual void draw(FrameEventArgs e)
        {
            ...
            int tempscaleX = Rect.scaledToX(location.X);
            int tempscaleY = Rect.scaledToY(location.Y);
            int tempscaleW = Rect.scaledToX(TextBitmap.Width);
            int tempscaleH = Rect.scaledToY(TextBitmap.Height);
            GL.LineWidth(2f);
            if (shadow)
            {
                ...
                GL.TexCoord2(0, 0);
                GL.Vertex2(tempscaleX + 2, tempscaleY + 2);
                GL.TexCoord2(1, 0);
                GL.Vertex2(tempscaleX + 2 + tempscaleW, tempscaleY + 2);
                GL.TexCoord2(1, 1);
                GL.Vertex2(tempscaleX + 2 + tempscaleW, tempscaleY + 2 + tempscaleH);
                GL.TexCoord2(0, 1);
                GL.Vertex2(tempscaleX + 2, tempscaleY + 2 + tempscaleH);
                GL.End();
            }
