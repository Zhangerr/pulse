...
namespace Pulse.UI
{
    class Button : Control
    {
        ...
        public Color Colour
        {
            set
            {
                texture.Colour = new OpenTK.Graphics.Color4(value.R / 255.0f, value.G / 255.0f, value.B / 255.0f, 1.0f);
                if (stretchable)
                {
                    end1.Colour = new OpenTK.Graphics.Color4(value.R / 255.0f, value.G / 255.0f, value.B / 255.0f, 1.0f);
                    end2.Colour = new OpenTK.Graphics.Color4(value.R / 255.0f, value.G / 255.0f, value.B / 255.0f, 1.0f);
                }
            }
        }
