    ...
    //    Rect test;
        ...
        public override void OnUpdateFrame(OpenTK.FrameEventArgs e)
        {
         ...
         /*   if (test != null)
            ...
            float temp = Game.M.CurrentSong.getPulsePercent((int)Game.M.Music.PositionAsMilli);
            bg2.Bounds = new Rectangle((int)(0 - (20 * (temp + 2))), (int)(0 - ((768 / 20) * (temp + 2))), (int)(Config.ResWidth + (40 * (temp + 2))), (int)(768 + ((768 / 10) * (temp + 2))));
            bg2.Alpha = 0.6f - (temp / 10f);
