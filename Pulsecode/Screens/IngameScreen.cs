...
namespace Pulse.Screens
{
    class IngameScreen : Screen
    {
        ...
        private void adjustHp(int adjust)
        {
            ...
            hpBar.Colour = new Color4(1.0f - (hp / 200.0f), 0.0f, hp / 200.0f, 1.0f);
        ...
        public override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            if (!scores)
            {
                ...
                if (pulse)
                {
                    ...
                    float temp = currentSong.getPulsePercent((int)music.PositionAsMilli);
                ...
                else if (accBurst != null && accBurst.Colour.A > 0)
                {
                    accBurst.draw(e);
                }
            }
